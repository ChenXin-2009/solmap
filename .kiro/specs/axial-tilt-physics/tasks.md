...
- [ ] 9. 集成到 Planet 类
  ...
  - [ ] 9.2 重构 updateRotation 方法
    - 使用 MeshOrientationManager.applyDailyRotation
    - 确保绕正确的轴旋转
    - _Requirements: 4.5_
  - [ ] 9.3 添加 setSpinAxisVector 方法
    - 作为设置朝向的唯一公开方法
...
- [ ] 10. 添加迁移工具和弃用警告
  - [ ] 10.1 创建 migrateLegacyObliquity 工具函数
